...
| 修改门店基础信息  | DATA_SHOP_UPDATE_BASE                     | {"id":"XXXX"}                                                              |
| 修改门店地址信息  | DATA_SHOP_UPDATE_ADDRESS                  | {"id":"XXXX"}                                                              |
...
| 修改门店状态    | DATA_SHOP_UPDATE_STATUS                   | {"id":"XXXX","status":"UNDER_CONSTRUCTION"} <br/> (枚举类：ShopStatusEnum)     |
| 修改门店动作    | DATA_SHOP_UPDATE_ACTION                   | {"id":"XXXX","action":"CONSTRUCTION_COMPLETED"} <br/> (枚举类：ShopActionEnum) |
