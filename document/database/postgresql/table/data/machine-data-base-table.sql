...
DROP TABLE IF EXISTS t_data_merchant;
CREATE TABLE t_data_merchant
(
    id               VARCHAR(32) NOT NULL,
    code             VARCHAR(16) NOT NULL,
    ...
    update_by        VARCHAR(32) NOT NULL,
    update_time      BIGINT NOT NULL,
    CONSTRAINT pk_t_data_merchant PRIMARY KEY (id),
    CONSTRAINT uk_t_data_merchant_01 UNIQUE (code)
);

CREATE INDEX idx_t_data_merchant_01 ON t_data_merchant (create_time);

COMMENT ON TABLE t_data_merchant IS '商家信息表';
COMMENT ON COLUMN t_data_merchant.id IS 'ID';
COMMENT ON COLUMN t_data_merchant.code IS '编码';
COMMENT ON COLUMN t_data_merchant.name IS '名称';
COMMENT ON COLUMN t_data_merchant.type IS '类型';
COMMENT ON COLUMN t_data_merchant.status IS '状态';
COMMENT ON COLUMN t_data_merchant.description IS '描述';
COMMENT ON COLUMN t_data_merchant.create_by IS '创建人';
COMMENT ON COLUMN t_data_merchant.create_time IS '创建时间';
COMMENT ON COLUMN t_data_merchant.update_by IS '修改人';
COMMENT ON COLUMN t_data_merchant.update_time IS '更新时间';
