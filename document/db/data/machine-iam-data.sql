DELETE
FROM `machine_iam`.`t_iam_user`;
INSERT INTO `machine_iam`.`t_iam_user` (`id`, `user_name`, `status`, `password`, `code`, `phone`, `name`, `gender`,
...
DELETE
FROM `machine_iam`.`t_iam_user_type_relation`;
INSERT INTO `machine_iam`.`t_iam_user_type_relation` (`id`, `user_id`, `user_type`, `sort`, `create_by`, `create_time`,
...
DELETE
FROM `machine_iam`.`t_iam_organization`;
INSERT INTO `machine_iam`.`t_iam_organization` (`id`, `parent_id`, `NAME`, `CODE`, `type`, `description`, `sort`,
...
DELETE
FROM `machine_iam`.`t_iam_role`;
INSERT INTO `machine_iam`.`t_iam_role`
...
DELETE
FROM `machine_iam`.`t_iam_user_organization_relation`;
INSERT INTO `machine_iam`.`t_iam_user_organization_relation`
...
DELETE
FROM `machine_iam`.`t_iam_permission`;
INSERT INTO `machine_iam`.`t_iam_permission` (`id`, `parent_id`, `resource_type`, `code`, `name`,
...
INSERT INTO `machine_iam`.`t_iam_role` (`id`, `parent_id`, `code`, `status`, `type`, `NAME`, `description`, `sort`,
                                    `create_by`, `create_time`, `update_by`, `update_time`)
