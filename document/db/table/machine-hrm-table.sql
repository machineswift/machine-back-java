...
CREATE TABLE `t_department` (
	...
	`establish_date` BIGINT UNSIGNED COMMENT '设立日期',
	`start_date` BIGINT UNSIGNED COMMENT '生效日期',
	`stop_time` BIGINT UNSIGNED COMMENT '失效日期',
...
DROP TABLE IF EXISTS `t_job_post_role_relation`;
CREATE TABLE `t_job_post_role_relation` (
	`id` VARCHAR ( 32 ) NOT NULL COMMENT 'ID',
