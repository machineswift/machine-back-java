package com.machine.app.admin.data.shop.controller.vo.response;
...
@Schema
@NoArgsConstructor
public class DataShopExpandListResponseVo {
    ...
    private List<DataShopDetailResponseVo.LabelOption> labelOptionList;
