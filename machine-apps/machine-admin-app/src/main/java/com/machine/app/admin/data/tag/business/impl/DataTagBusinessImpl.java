package com.machine.app.admin.data.tag.business.impl;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.json.JSONUtil;
import com.machine.app.admin.data.tag.business.IDataTagBusiness;
import com.machine.app.admin.data.tag.controller.vo.request.*;
import com.machine.app.admin.data.tag.controller.vo.response.DataTagDetailResponseVo;
import com.machine.app.admin.data.tag.controller.vo.response.DataTagExpandListResponseVo;
import com.machine.app.admin.data.tag.controller.vo.response.DataTagSimpleListResponseVo;
...
public class DataTagBusinessImpl implements IDataTagBusiness {
    ...
    @Override
    public void updateCode(DataTagUpdateCodeRequestVo request) {
        DataTagUpdateCodeInputDto inputDto = JSONUtil.toBean(JSONUtil.toJsonStr(request), DataTagUpdateCodeInputDto.class);
        tagClient.updateCode(inputDto);
    }

    @Override
    public void updateStatus(DataTagUpdateStatusRequestVo request) {
        DataTagUpdateStatusInputDto inputDto = JSONUtil.toBean(JSONUtil.toJsonStr(request), DataTagUpdateStatusInputDto.class);
        tagClient.updateStatus(inputDto);
    }

    @Override
    public void updateSort(DataTagUpdateSortRequestVo request) {
        DataTagUpdateSortInputDto inputDto = JSONUtil.toBean(JSONUtil.toJsonStr(request), DataTagUpdateSortInputDto.class);
        tagClient.updateSort(inputDto);
    }
