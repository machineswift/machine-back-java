...
import com.machine.app.iam.organization.controller.vo.response.IamOrganizationLeaderResponseVo;
...
public class IamOrganizationExpandTreeBo extends TreeNode<IamOrganizationExpandTreeBo> {
    ...
    private List<DataShopListOutputDto> bindShopList;
    ...
    private IamOrganizationLeaderResponseVo organizationLeader;
