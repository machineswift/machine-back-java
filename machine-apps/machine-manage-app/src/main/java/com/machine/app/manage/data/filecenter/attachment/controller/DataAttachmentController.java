package com.machine.app.manage.data.filecenter.attachment.controller;

import com.machine.app.manage.data.filecenter.attachment.business.IDataAttachmentBusiness;
import com.machine.app.manage.data.filecenter.attachment.controller.vo.response.DataAttachmentUrlResponseVo;
...
@Tag(name = "【DATA】附件模块")
@RestController
@RequestMapping("manage/data/file_center/attachment")
