...
public class IOpenApiPermissionController {
    ...
    public List<PermissionTreeOutputDto> listApp(@RequestBody @Validated OpenApiPermissionQueryAppListRequestVo request) {
    ...
    @PostMapping("detail")
    @PreAuthorize("hasAnyAuthority('iam','iam_permission')")
    public PermissionTreeOutputDto detail(@RequestBody @Valid OpenApiPermissionIdRequestVo requestVo) {
    ...
    @PreAuthorize("hasAnyAuthority('iam','iam_permission')")
    public List<PermissionTreeOutputDto> listSub(@RequestBody @Valid OpenApiPermissionListSubRequestVo request) {
