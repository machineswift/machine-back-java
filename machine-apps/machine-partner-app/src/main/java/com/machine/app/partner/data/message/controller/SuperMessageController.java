package com.machine.app.partner.data.message.controller;

import com.machine.app.partner.data.message.business.ISuperMessageBusiness;
import com.machine.app.partner.data.message.controller.vo.request.*;
...
@Tag(name = "【DATA】消息模块")
@RestController
@RequestMapping("partner/data/message")
