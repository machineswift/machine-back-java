package com.machine.app.partner.data.shop.controller;

import cn.hutool.json.JSONUtil;
import com.machine.app.partner.data.shop.business.IUserCollectShopBusiness;
import com.machine.app.partner.data.shop.controller.vo.request.*;
import com.machine.app.partner.data.shop.controller.vo.response.SuperShopListSimpleResponseVo;
...
@Tag(name = "【DATA】门店模块")
@RestController
@RequestMapping("partner/data/shop")
