...
public class SuperAreaController {
    ...
    public AreaTreeOutputDto treeSelfSimple(@RequestBody @Validated SuperAreaTreeRequestVo request) {
    ...
    public AreaTreeOutputDto treeAllSimple(@RequestBody @Validated SuperAreaTreeRequestVo request) {
