...
public enum EventTypeEnum implements BaseEnum<EventTypeEnum, String> {
    ...
    IAM_PERMISSION_UPDATE_STATUS("IAM_PERMISSION_UPDATE_STATUS", "修改权限状态"),
    ...
    DATA_SHOP_UPDATE_BASE("DATA_SHOP_UPDATE_BASE", "修改门店基础信息"),
    DATA_SHOP_UPDATE_STATUS("DATA_SHOP_UPDATE_STATUS", "修改门店状态"),
    DATA_SHOP_UPDATE_ADDRESS("DATA_SHOP_UPDATE_ADDRESS", "修改门店地址信息"),
