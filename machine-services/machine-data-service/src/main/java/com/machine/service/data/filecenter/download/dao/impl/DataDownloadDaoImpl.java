package com.machine.service.data.filecenter.download.dao.impl;
...
import com.machine.service.data.filecenter.download.dao.mapper.DataDownloadMapper;
...
public class DataDownloadDaoImpl implements IDataDownloadDao {
    ...
    public List<DataDownloadEntity> queryByLimit(DataDownloadQueryInputDto inputDto) {
        ...
        return dataDownloadMapper.selectList(wrapper);
    }
