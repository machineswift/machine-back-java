package com.machine.service.data.filecenter.download.server;
...
public class DataDownloadServer implements IDataDownloadClient {
    ...
    public DataDownloadDetailOutputDto getById(@RequestBody @Validated IdRequest request) {
        return downloadService.getById(request.getId());
    }
