...
import com.machine.service.data.filecenter.material.dao.mapper.DataMaterialCategoryMapper;
...
public class DataMaterialCategoryDaoImpl implements IDataMaterialCategoryDao {
    ...
    public DataMaterialCategoryEntity getByParentIdAndName(String parentId, String name) {
        Wrapper<DataMaterialCategoryEntity> wrapper = new LambdaQueryWrapper<DataMaterialCategoryEntity>()
                .eq(DataMaterialCategoryEntity::getParentId, parentId)
                .eq(DataMaterialCategoryEntity::getName, name);
        return materialCategoryMapper.selectOne(wrapper);
    }

    @Override
    public List<DataMaterialCategoryEntity> listAll() {
        Wrapper<DataMaterialCategoryEntity> wrapper = new LambdaQueryWrapper<>();
