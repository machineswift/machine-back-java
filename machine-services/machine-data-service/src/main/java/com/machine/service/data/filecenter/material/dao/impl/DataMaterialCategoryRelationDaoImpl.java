...
import com.machine.service.data.filecenter.material.dao.mapper.DataMaterialCategoryRelationMapper;
import com.machine.service.data.filecenter.material.dao.mapper.entity.DataMaterialCategoryRelationEntity;
...
public class DataMaterialCategoryRelationDaoImpl implements IDataMaterialCategoryRelationDao {
    ...
    public Long selectCountByCategoryId(String categoryId) {
        ...
        Wrapper<DataMaterialCategoryRelationEntity> wrapper = new LambdaQueryWrapper<DataMaterialCategoryRelationEntity>()
                .eq(DataMaterialCategoryRelationEntity::getCategoryId, categoryId);
        return materialCategoryRelationMapper.selectCount(wrapper);
    }
    ...
    public void deleteByMaterialId(String materialId) {
        ...
        materialCategoryRelationMapper.delete(wrapper);
    }
    ...
    public List<DataMaterialCategoryRelationEntity> listByMaterialId(String materialId) {
        ...
        Wrapper<DataMaterialCategoryRelationEntity> wrapper = new LambdaQueryWrapper<DataMaterialCategoryRelationEntity>()
                .eq(DataMaterialCategoryRelationEntity::getMaterialId, materialId);
        return materialCategoryRelationMapper.selectList(wrapper);
    }
