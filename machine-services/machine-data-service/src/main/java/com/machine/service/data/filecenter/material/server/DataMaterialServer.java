...
public class DataMaterialServer implements IDataMaterialClient {
    ...
    public void updateAttachmentId(@RequestBody @Validated DataMaterialUpdateAttachmentIdInputDto inputDto) {
        log.info("修改素材附件ID，inputDto={}", JSONUtil.toJsonStr(inputDto));
        materialService.updateAttachmentId(inputDto);
    }
