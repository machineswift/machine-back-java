...
public class FranchiseeShopRelationServer implements IFranchiseeShopRelationClient {

    @Autowired
    private IFranchiseeShopRelationService franchiseeShopRelationService;
