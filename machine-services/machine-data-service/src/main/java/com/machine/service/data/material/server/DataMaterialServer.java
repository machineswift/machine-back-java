...
@Slf4j
@RestController
@RequestMapping("server/data/material")
public class DataMaterialServer implements IDataMaterialClient {
    ...
    public String createTemporary(@RequestBody @Validated DataMaterialCreateTemporaryInputDto inputDto) {
        log.info("创建临时素材，inputDto={}", JSONUtil.toJsonStr(inputDto));
        return materialService.createTemporary(inputDto);
    }
