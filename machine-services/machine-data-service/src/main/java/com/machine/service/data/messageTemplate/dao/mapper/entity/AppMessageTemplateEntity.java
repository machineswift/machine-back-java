package com.machine.service.data.messageTemplate.dao.mapper.entity;
...
@Data
@NoArgsConstructor
@TableName("t_app_message_template")
@EqualsAndHashCode(callSuper = true)
public class AppMessageTemplateEntity extends BaseEntity {
