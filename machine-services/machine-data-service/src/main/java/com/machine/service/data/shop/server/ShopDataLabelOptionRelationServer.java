...
public class ShopDataLabelOptionRelationServer implements IShopLabelOptionRelationClient {

    @Autowired
    private IShopLabelOptionRelationService shopLabelOptionRelationService;
