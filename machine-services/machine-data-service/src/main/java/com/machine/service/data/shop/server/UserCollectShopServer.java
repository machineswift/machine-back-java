...
public class UserCollectShopServer implements IDataUserCollectShopClient {

    @Autowired
    private IUserCollectShopService userCollectShopService;

    @Override
    @PostMapping("collect_shop")
    public void collectShop(@RequestBody @Validated SuperShopCollectIdInputDto inputDto) {
    ...
    public PageResponse<DataShopListOutputDto> pageCollectShop(@RequestBody @Validated SuperShopListCollectShopInputDto inputDto) {
