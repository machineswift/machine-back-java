...
public class UserRoleBusinessRelationServer implements IIamUserRoleBusinessRelationClient {

    @Autowired
    private IUserRoleBusinessRelationService userRoleBusinessRelationService;
