...
@Slf4j
@Component
public class RedisIamOrganizationCache {
    ...
    public IamOrganizationTreeSimpleOutputDto treeAllSimple(IamOrganizationTypeEnum type) {
        ...
        { //添加【未分配】
            ...
            virtualSimpleTreeBo.setId(typeName + SEPARATOR_COLON + DATA_ORGANIZATION_VIRTUAL_NODE);
            ...
            virtualSimpleTreeBo.setCode(typeName + SEPARATOR_COLON + DATA_ORGANIZATION_VIRTUAL_NODE.toUpperCase());
