...
public class CustomerOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    ...
    public void remove(OAuth2AuthorizationConsent authorizationConsent) {
        AppContext.getContext().setUserId(SYSTEM_USER_ID);
        Oauth2AuthorizationConsentInputDto dto = new Oauth2AuthorizationConsentInputDto();
    ...
    public OAuth2AuthorizationConsent findById(String registeredClientId, String principalName) {
        ...
        Oauth2AuthorizationConsentOutputDto inputDto = authorizationConsentClient.findById(dto);
