...
public class CustomerRegisteredClientRepository implements RegisteredClientRepository {
    ...
    public RegisteredClient findById(String id) {
        AppContext.getContext().setUserId(SYSTEM_USER_ID);
        OAuth2RegisteredClientDetailOutputDto dto = registeredClientClient.getById(id);
    ...
    public RegisteredClient findByClientId(String clientId) {
        AppContext.getContext().setUserId(SYSTEM_USER_ID);
        OAuth2RegisteredClientDetailOutputDto dto = registeredClientClient.getByClientId(clientId);
        if(Objects.isNull(dto)){
            return null;
        }
