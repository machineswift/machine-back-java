...
public class CustomerLoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        LoginResponse loginResponse = new LoginResponse(accessToken, accessTokenExpire, refreshToken);
        response.setContentType("application/json;charset=UTF-8");
        ServletOutputStream outputStream = response.getOutputStream();
        AppResult<LoginResponse> result = AppResult.success(loginResponse);
