...
import static com.machine.starter.redis.constant.RedisLockPrefixConstant.Iam.IAM_AUTH_SMS_CAPTCHA_PHONE_LOGIN_SUBMIT_LOCK;
...
public class SmsAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        appContext.setAuthMethod(AuthMethodEnum.PHONE_CAPTCHA);
    ...
    private void validate(String phone,
        ...
        RLock lock = redissonClient.getLock(IAM_AUTH_SMS_CAPTCHA_PHONE_LOGIN_SUBMIT_LOCK + phone);
        try {
            lock.lock();
