...
public class LoginLogUtil {
    ...
    public static IamUserLoginLogCreateInputDto getUserLoginLogCreateInputDto(UserDetailOutputDto userSimple) {
    ...
    public static List<String> blackAllAvailableToken(MachineJwtUtil machineJwtUtil,
        ...
        //查询当前用户的可用 AuthToken
        List<UserLoginLogAvailableOutputDto> outputDtoList = loginLogClient.selectAvailableToken(
        ...
        for (UserLoginLogAvailableOutputDto outputDto : outputDtoList) {
